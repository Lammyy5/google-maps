...
function initialize(){
    ...
    var map = new google.maps.Map(document.getElementById
        ...
        // Create a marker for example : California, Riverside
        var mmarker = new google.maps.Marker({
            // Cordinates for California, Riverside
            position: new google.maps.LatLng(33.953350, -117.396156),
            // Attach the marker
            map: map,
            // Tooltip on hover 
            title: 'California, Riverside'
        });
